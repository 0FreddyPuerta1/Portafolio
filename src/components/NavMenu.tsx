...
export default function NavMenu(): JSX.Element {
  ...
  return (
    <motion.div
      ...
      className="flex ml-[-8px] md:m-[-150px] md:max-h-[300px] md:w-12 bg-goldGradient fixed bottom-0 w-full p-2 md:rounded-full md:flex-col md:mr-20 md:w-auto md:h-auto md:right-0 md:top-1/2 md:translate-y-[-50%] z-10"
    >
